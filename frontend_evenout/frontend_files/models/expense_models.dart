class TransactionDetail {
  ...
  TransactionDetail({required this.description, required this.category, required this.amount});
}
...
// The exact data from your Figma mockups
final List<FriendBalance> mockBalances = [
  FriendBalance(
    name: 'Asmit Ghimire',
    amount: 50.00,
    avatarUrl: 'https://i.pravatar.cc/150?u=asmit', // Placeholder
    details: [
